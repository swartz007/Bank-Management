...
<div class="container">
<h2 class="text-center" style="margin-top: 100px; color: #ff0000;">Transaction</h2>
<br>
<br>
<div class="row">
<form method="POST" name="send">
<table class="table table-hover" style="color: #ff0000; ">
<thead>
<th>ID</th>
<th>Name</th>
<th>Email</th>
...
<br><br>
<label style="color: #ff0000; ">Transfer To:</label>
...
<br>
<br>
<label style="color: #ff0000; ">Amount:</label>
